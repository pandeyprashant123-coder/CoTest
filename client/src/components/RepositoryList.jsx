...
const RepositoryList = ({ accessToken }) => {
  ...
  const fetchAllRepositories = async () => {
    ...
    try {
      ...
      console.log(
        ...
        allReposData.map((repo) => repo.language)
      );
  ...
  return (
    ...
    >
      <div className="mb-5 flex flex-col justify-center items-center space-x-2">
        <h2 className="font-semibold text-[20px] ">User's Repositories</h2>
